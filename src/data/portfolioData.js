...
export const projects = {
  ...
  psq: {
    ...
    items: [
      "2년 동안 5명이던 팀이 30명이 되는 과정에서 초기멤버로서 의도적인 팀 빌딩을 주도했고 암묵지를 구조적으로 전파했습니다.”, “핵심지표를 설정하고, 해당 데이터를 통해 인사이트를 추출하고, 빠르게 서비스에 반영했습니다.”, “핵심 가치와 비전을 정의하고 장기적 사업 방향성을 수립하는데 참여했습니다.”, “회사와 서비스의 핵심 가치를 전파하기 위한 브랜딩 작업을 하고 보도자료 작성, 벤처 진행 등 이를 외부에 알리는 일을 담당했습니다.”, “축제, 차량 관련 서비스, 공연장 제휴 등 유저 확장을 위한 채널을 발굴하고, 기획, 실행했습니다."
    ],
